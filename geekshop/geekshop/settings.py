...
SECRET_KEY = "django-insecure-nch6u-i&dui7h^4u5=8fm&7$@72^aj)6085(#2)vvcqdm&feu5"

# SECURITY WARNING: don"t run with debug turned on in production!
DEBUG = True #Сейчас выставлен по умолчанию
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'authapp.pipeline.get_github_user_info',
)
